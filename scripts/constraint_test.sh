...
SIMXY=('28.8 -92.7' '28.75 -93.25' '25.00 -96.50' '28.82 -91.19')
#'29.00 -91.7'
  ...
  do
    ...
    do
      ...
      do
        ...
        do
          echo $c $b $x $y
          $PATH/src/mip_test.py -n $b -s $x $y -t 300 -r glider1 -o $outfile_path --experiment_name $experiment_name $c --sim_cfg $SIM
